...
const ServiceDetail = ( { postData } ) => {
  return (
    <Layouts>
      <PageBanner pageTitle={postData.title} pageDesc={"Post-tensioning and structural systems designed for high-rise towers, residential, and commercial developments."} />
