            ...
            <div className="footer-first">
                ...
                <div className="contact-info d-flex-all">
                    <div className="images d-flex-all justify-content-start">
                        <figure>
                            <img src="/img/call-icon.png" alt="Contact Images" />
                        </figure>                   
                    </div>                   
                </div>
        ...
        <div className="container">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    <h3>Information</h3>
                    <p>We successfully execute post-tensioning works of varying complexity, ensuring structural integrity, long-term performance, and continuous adoption of advanced technologies.</p>
                </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
